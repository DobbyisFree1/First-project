...
public class BoardController extends HttpServlet {
	...
	private void detail2(HttpServletRequest request, HttpServletResponse response) 
			throws ServletException, IOException {
    	long seq = -1;
    	String seqStr = request.getParameter("seq");
    	if(seqStr != null){
